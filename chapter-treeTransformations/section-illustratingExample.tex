%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                              %
%   Tree Transformations - Illustrating Example                                %
%                                                                              %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}
	...
	\scalebox{0.8}{\begin{tikzpicture}[node distance=5mm, ]
		\node[] (p1) {+};
...
\end{scope}
  ...
  \Description{Destination function example}
\end{figure} 
...
Consider the transformation depicted in Figure~\ref{fig:trans-ex}. %Note that $e_i$s and $t$ can a
